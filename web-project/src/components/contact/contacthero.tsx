...
import ContactHeroImg from '../../assets/contact/contactusheader.jpg';
        ...
        <section className="relative w-full h-[40vh] min-h-[300px] md:h-[60vh] md:min-h-[400px] max-h-[600px] flex items-center justify-center overflow-hidden bg-slate-900">
            ...
            <div className="relative z-10 w-full max-w-5xl mx-auto px-6 text-center text-white flex flex-col items-center gap-4">
                ...
                <p className="text-sm md:text-base font-normal tracking-wide leading-relaxed max-w-2xl text-white drop-shadow-sm">
                    Get in touch with our team for expert accounting, tax, and advisory support. We are here to answer your questions and help your business move forward with confidence. </p>
            </div>
        </section>
    );
};
