...
export const ResourceFounder: React.FC = () => {
    return (
        <section className="w-full bg-[#FFFFFF] py-16 md:py-24 px-6 md:px-12 lg:px-24 select-none">
...
export default ResourceFounder;